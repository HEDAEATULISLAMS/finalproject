    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="{{url::to('employee_register')}}">Employee</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="{{URL::to('write_post')}}">Profile</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="{{url::to('contact')}}">Jobs</a>
          </li>
         
          <li class="nav-item">
            <a class="nav-link" href="{{url::to('seeker/login')}}">Logout</a>
          </li>
        </ul>
      </div>
    </div>
